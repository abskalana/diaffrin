...
class Entity(models.Model):
    ...
    quartier = models.CharField(max_length=50, default="No", blank=True, null=True)
    category = models.CharField(max_length=100)
    speciality = models.CharField(max_length=100, default="No",blank=True, null=True)
    nom = models.CharField(max_length=100, default="",blank=True, null=True)
    horaire = models.CharField(max_length=50, default="08h-20h")
    property = models.CharField(max_length=30, default="PRIVEE")
    nom_complet = models.CharField(max_length=100, default="No",blank=True, null=True)
